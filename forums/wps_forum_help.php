...
function wps_admin_getting_started_forum() {
    ...
    $css = isset($_POST['wps_expand']) && $_POST['wps_expand'] == 'wps_admin_getting_started_forum' ? 'wps_admin_getting_started_menu_item_remove_icon ' : '';    
  	echo '<div class="'.$css.'wps_admin_getting_started_menu_item" rel="wps_admin_getting_started_forum">'.__('Forum', WPS2_TEXT_DOMAIN).'</div>';
  	...
  	echo '<div class="wps_admin_getting_started_content" id="wps_admin_getting_started_forum" style="display:'.$display.'">';
		...
		<tr class="form-field">
			...
			<td>
				...
				<br /><span class="description"><?php _e('Number of days after no activity that a forum post will close automatically (blank for never).', WPS2_TEXT_DOMAIN); ?></span>
			</td>
		</tr> 
		<?php 
