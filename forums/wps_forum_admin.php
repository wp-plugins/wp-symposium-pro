			...
			echo '<form action="" method="POST">';
				...
				foreach ($terms as $term):
					...
					echo '<tr>';
						...
						echo '<strong><a style="text-decoration:none" href="edit-tags.php?action=edit&taxonomy=wps_forum&tag_ID='.$term->term_id.'&post_type=wps_forum_post">'.$term->name.'</a></strong><br />';
						...
						if ( !wps_get_term_meta($term->term_id, 'wps_forum_author', true) ):
							...
							echo '<option value="0">'.__('Own', WPS2_TEXT_DOMAIN).'</option>';
