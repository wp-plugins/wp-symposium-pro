...
function wps_taxonomy_metadata_edit( $tag ) {
	...
	<tr class="form-field">
		...
		<td>
            <input id="wps_upload_image" type="text" style="width: 50%" name="wps_forum_featured_image" value="<?php echo wps_get_term_meta($tag->term_id, 'wps_forum_featured_image', true); ?>" /> 
            <input id="wps_upload_image_button" type="button" class="button-secondary" value="<?php _e('Select from Media Library', WPS2_TEXT_DOMAIN); ?>" /><br />
