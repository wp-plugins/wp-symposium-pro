...
function add_wps_forum_custom_taxonomies() {
	...
	register_taxonomy('wps_forum', 'wps_forum_post', array(
		...
		'labels' => array(
			...
			'add_new_item' 		=> '<p><input type="button" rel="admin.php?page=wpspro_forum_setup" class="wps-go-to-all-forums button-primary" value="'.__('Forum Administration', WPS2_TEXT_DOMAIN).'" /></p><br />'.__( 'Add New Forum', WPS2_TEXT_DOMAIN ),
