...
Description: Quickly and easily add a social network to your website!
Version: 0.56.3
...
function wps_init() {
	...
	// Friendships
	wp_enqueue_script('wps-friendship-js', plugins_url('friendships/js/wps_friends.js', __FILE__), array('jquery'));
