...
function wps_alerts_clear_sent( $views )
{
	if ( current_user_can( 'manage_options' ) ):
	    ...
	    $views['wps-alerts-clear-sent'] = '<a id="wps_alerts_clear_sent" href="edit.php?post_type=wps_alerts&wps_action=wps_alerts_clear_sent&_wpnonce='.$nonce.'">'.__('Remove all sent alerts', WPS2_TEXT_DOMAIN).'</a>';
	    $views['wps-alerts-pending-sent'] = '<a id="wps_alerts_clear_sent" href="edit.php?post_type=wps_alerts&wps_action=wps_alerts_clear_pending&_wpnonce='.$nonce.'">'.__('Remove all pending alerts', WPS2_TEXT_DOMAIN).'</a>';
    	return $views;
