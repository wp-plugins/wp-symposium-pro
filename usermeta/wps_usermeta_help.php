...
function wps_admin_quick_start_profile_save($the_post) {
	...
	if (isset($the_post['wpspro_quick_start']) && $the_post['wpspro_quick_start'] == 'profile'):
		...
		// Friends Page
		$post = array(
		  'post_content'   => '['.WPS_PREFIX.'-friends count="100"]',
		  'post_name'      => 'friends',
...
function wps_admin_getting_started_profile() {
	...
	// Show menu item	
  	...
  	echo '<div class="wps_admin_getting_started_content" id="wps_admin_getting_started_profile" style="display:none">';
	?>
		...
		<table class="form-table">
			...
			<tr valign="top"> 
			<td scope="row"><label for="icon_colors"><?php echo __('Icon Colors', WPS2_TEXT_DOMAIN); ?></label></td>
			<td>
				...
				<span class="description"><?php echo __('Icon color scheme to use.', WPS2_TEXT_DOMAIN); ?></span></td> 
			</tr> 
