                ...
                if ($max_tabs):
                    ...
                    $html .= '<div class="wps-tabs">';
                        $html .= '<ul class="wps-tab-links">';
                            $html .= '<li class="active"><a href="#tab1">'.$wps_profile_tab1.'</a></li>';
                            if ($wps_profile_tab2) $html .= '<li><a href="#tab2">'.$wps_profile_tab2.'</a></li>';
                            if ($wps_profile_tab3) $html .= '<li><a href="#tab3">'.$wps_profile_tab3.'</a></li>';
                            if ($wps_profile_tab4) $html .= '<li><a href="#tab4">'.$wps_profile_tab4.'</a></li>';
                            if ($wps_profile_tab5) $html .= '<li><a href="#tab5">'.$wps_profile_tab5.'</a></li>';
                            if ($wps_profile_tab6) $html .= '<li><a href="#tab6">'.$wps_profile_tab6.'</a></li>';
                            if ($wps_profile_tab7) $html .= '<li><a href="#tab7">'.$wps_profile_tab7.'</a></li>';
                            if ($wps_profile_tab8) $html .= '<li><a href="#tab8">'.$wps_profile_tab8.'</a></li>';
                            if ($wps_profile_tab9) $html .= '<li><a href="#tab9">'.$wps_profile_tab9.'</a></li>';
                            if ($wps_profile_tab10) $html .= '<li><a href="#tab10">'.$wps_profile_tab10.'</a></li>';
                        $html .= '</ul>';
                        ...
                        $html .= '<div class="wps-tab-content">';
                            ...
                            while ($tab_ptr <= $max_tabs)
                            {
                                ...
                                $html .= '"><div class="wps-tab-content-inner">';
                                foreach ($tabs as $tab):
                                    if ($tab['tab'] == $tab_ptr):
                                        $html .= '<p>'.$tab['html'].'</p>';                                        
                                    endif;
