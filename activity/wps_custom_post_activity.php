...
function wps_custom_post_activity() {
	$labels = array(
		'name'               => _x( 'Activity', 'post type general name', WPS2_TEXT_DOMAIN ),
		'singular_name'      => _x( 'Activity', 'post type singular name', WPS2_TEXT_DOMAIN ),
		'add_new'            => _x( 'Add New', 'wps_activity', WPS2_TEXT_DOMAIN ),
