...
function wps_admin_getting_started_options() {
    ...
    $css = ( (!isset($_POST['wps_expand'])) || (isset($_POST['wps_expand']) && $_POST['wps_expand'] == 'wps_admin_getting_started_options') ) ? 'wps_admin_getting_started_menu_item_remove_icon ' : '';    
  	echo '<div style="margin-top:25px" class="'.$css.'wps_admin_getting_started_menu_item" rel="wps_admin_getting_started_options">'.__('Default Shortcode Settings', WPS2_TEXT_DOMAIN).'</div>';    
	$display = ( (!isset($_POST['wps_expand'])) || ((isset($_POST['wps_expand']) && $_POST['wps_expand'] == 'wps_admin_getting_started_options')) ) || (isset($_GET['wps_expand']) && $_GET['wps_expand'] == 'wps_admin_getting_started_options') ? 'block' : 'none';
  	echo '<div class="wps_admin_getting_started_content" id="wps_admin_getting_started_options" style="display:'.$display.'">';
        ...
        echo '<div id="wps_admin_getting_started_options_outline">';
            ...
            if (isset($_GET['wps_reset_options'])) {
                ...
                echo '<p style="margin-top:-8px">'.sprintf(__('To the left, select a general area, then a shortcode. You can then see and set the default values and get further help for that shortcode. To reset a value, remove the value and Save, or <a href="%s">reset all shortcode options</a>.', WPS2_TEXT_DOMAIN), admin_url( 'admin.php?page=wps_pro_shortcodes&wps_reset_options=1' )).'<br />';
                ...
                echo '<div id="wps_admin_getting_started_options_left_and_middle">';
                ...
                echo '<div id="wps_admin_getting_started_options_right">';
                    ...
                    echo wps_show_options($wps_expand_shortcode, 'wps_activity_page_tab');
                        ...
                        echo '<table cellpadding="0" cellspacing="0"  class="wps_shortcode_value_row">';
                            echo '<tr><td>'.__("Size of the user's avatar", WPS2_TEXT_DOMAIN).'</td><td>';
                                $user_avatar_size = wps_get_shortcode_default($values, 'wps_activity_page-user_avatar_size', 1500);
...
function wps_save_option($values, $the_post, $name, $checkbox=false) {
    ...
    $values[$name] = $v ? htmlentities (stripslashes($v), ENT_QUOTES) : '';
    return $values;
}
...
function wps_admin_getting_started_core() {
    ...
    $css = isset($_POST['wps_expand']) && $_POST['wps_expand'] == 'wps_admin_getting_started_core' ? 'wps_admin_getting_started_menu_item_remove_icon ' : '';    
  	echo '<div class="'.$css.'wps_admin_getting_started_menu_item" rel="wps_admin_getting_started_core">'.__('System Options', WPS2_TEXT_DOMAIN).'</div>';
