...
function wps_add_shortcode_button( $page = null, $target = null ) {
	...
	echo '<div id="wps_admin_shortcodes">';
		...
		echo '<div><a name="WP Symposium Pro" href="http://www.wpsymposiumpro.com/a-complete-guide-to-wp-symposium-pro-book/" target="_blank">'.__('Admin Guide', WPS2_TEXT_DOMAIN).'</a></div>';
