	  	...
	  	echo '<div id="wps_release_notes">';
            ...
            <table><tr>
				<td valign="top" class="wps_release_notes" style="<?php echo $cup_of_tea_left; ?>width:45%;">
                    ...
                    <h3>Admin Setup links</h3>
                    <p>You can now choose to show all the links to setup pages on WPS Pro->Setup page (default), or show them all on the admin dashboard menu. Switch between the two using a link on the setup page.</p>
                                        
                    <h3>Admin Setup page header</h3>
                    <p>To save space on the page, you can hide the header at the top, with the link on the setup page.</p>
				...
				<td valign="top" class="wps_release_notes" style="<?php echo $cup_of_tea_right; ?>">
                    ...
                    <h3>Licence code required for Extensions Plugin</h3>
                    <p>Unfortunately, due to a number of people not willing to do as others do, and purchase the plugin, an additional licence code is required for the Extensions plugin. It is a shame that the actions of a few people force this on others. If you have purchased the Extensions plugin, simply go to the <a href="http://www.wpsymposiumpro.com/licence-code">licence code page on the WP Symposium Pro website</a>, copy your licence code, and paste it on your <a href="<?php echo admin_url( 'admin.php?page=wps_pro_licence' ); ?>">licence admin page</a>. If you have any problems, please <a href="mailto:support@wpsymposiumpro.com">email support</a>.</p>

                    <h3>Admin pages for shortcode values completed</h3>
                    <p><strong>Easily view and change all the settings of WP Symposium Pro shortcodes!</strong></p>
                    <p>All <a href="<?php echo admin_url( 'admin.php?page=wps_pro_shortcodes' ); ?>">shortcode options</a> are now available, including those options that are added by Extensions (for example, the @tag help text on [wps-activity]).</p>

                    <h3>Restrict forum search to one forum</h3>
                    <p>New option 'slug' for [wps-forum-search-results] to restrict search results to one forum.</p>

                    <h3>Redirect user after logging out</h3>
                    <p>New option 'url_logout' for [wps-login-form] to redirect the user after using the logout button.</p>

                    <h3>Show help text for @tags</h3>
                    <p>To allow you to show and set help text, tag_help_text has been added to [wps-activity-post], [wps-forum-post] and [wps-forum-comment]. To enable also set tag_help="1".</p>

                    <h3>Set message text Activity To Facebook</h3>
                    <p>share_msg, connect_msg and disconnect_msg added to [wps-activity] to change the text.</p> 
...
function wps_pro_licence() {
  	...
  	echo '<div class="wrap">';
		...
		echo '<p>'.sprintf(__('If you have the <a href="%s" target="_blank">WP Symposium Pro Extensions plugin</a> activated, you will need to enter a licence code. Until you do so, a polite notice will be displayed on your site.', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.com/shop/').'</p>';
		...
		if (function_exists('__wps__wpspro_extensions_au')):
			...
			echo '<p>'.sprintf(__('To see all the extra features provided by the Extensions Plugin, visit <a href="%s" target="_blank">www.wpsymposiumpro.com</a>', WPS2_TEXT_DOMAIN), 'http://www.wpsymposiumpro.com/shop/').'</p>';
		endif;		
