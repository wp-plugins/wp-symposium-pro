...
function wpspro_release_notes() {
  	...
  	echo '<div class="wrap" style="border-radius:3px; border: 1px solid #000; background-color: #fff; padding: 0 20px 0 20px; margin: 30px 50px 40px 50px;">';
	  	...
	  	?>
            ...
            <strong>14.10.2: Fix to activity posts when adding images to a gallery, and fix for Enfold theme</strong><br />
            <strong>14.10.3: Can now add new recipients to a message, and remove them. Use [wps-mail-recipients add_recipient=0] to remove.</strong></p>
			...
			<table><tr>
				...
				<td valign="top">
					...
					<h3>Mail (Messages)</h3>
					<ol>
                        <li>Can now add new recipients to a message, and remove them. Use [wps-mail-recipients add_recipient=0] to remove. [14.10.3]</li>
