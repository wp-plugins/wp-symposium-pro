...
function wpspro_release_notes() {
  	...
  	echo '<div class="wrap" style="border-radius:3px; border: 1px solid #000; background-color: #fff; padding: 0 20px 0 20px; margin: 30px 50px 40px 50px;">';
	  	...
	  	?>
	  		...
	  		<h1>WP Symposium Pro Release Notes</h1>

            <p><strong>14.10.1: Additional items added to Groups, plus fix for YouTube Profile Extension</strong></p>

	  		<p>Current version of WP Symposium Pro installed: <?php echo get_option('wp_symposium_pro_ver'); ?></p>

	  		<p><em>These release notes are also available on the <a href="http://www.wpsymposiumpro.com" target="_blank">WP Symposium Pro blog</a>. 
