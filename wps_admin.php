...
function wpspro_release_notes() {
  	...
  	echo '<div class="wrap" style="border-radius:3px; border: 1px solid #000; background-color: #fff; padding: 0 20px 0 20px; margin: 30px 50px 40px 50px;">';
	  	...
	  	?>
	  		...
	  		They are shown automatically (just once) after updating the core plugin, and can be read again via your <a href="<?php echo admin_url('admin.php?page=wps_pro_release_notes'); ?>">WPS Pro->Release notes</a> admin menu item.</em></p>
