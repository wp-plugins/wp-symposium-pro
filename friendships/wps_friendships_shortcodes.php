		...
		if ($get_friends):
			...
			foreach ($friends as $friend):
				$html .= '<div id="wps_friends">';
					...
					$html .= '<div class="wps_friends_friend">';
					if ($size):
						$html .= '<div class="wps_friends_friend_avatar">';
					...
					if ($show_last_active && $friend['last_active']):
						$html .= '<br />'.$last_active_text.' '.sprintf(__('%s ago', WPS2_TEXT_DOMAIN), human_time_diff($friend['last_active'], current_time('timestamp', 1)), WPS2_TEXT_DOMAIN);
					endif;
					$html .= '</div>';
