			...
			elseif ($_POST['wps_avatar_change_step'] == '2'):
				...
				if( !file_exists($original_file) ):
					...
					if ($continue):
						...
						// update the files 
						$cropped_full = wp_crop_image( $original_file, $_POST['x1'], $_POST['y1'], $_POST['width'], $_POST['height'], 300, 300, false, $cropped_full );
						$cropped_thumb = wp_crop_image( $original_file, $_POST['x1'], $_POST['y1'], $_POST['width'], $_POST['height'], 300, 300, false, $cropped_thumb );
